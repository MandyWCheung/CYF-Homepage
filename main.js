...
document.getElementById('previous').addEventListener('click', (event) => {
  ...
  let element_image_carousel3 = document.getElementById('image-carousel');
  element_image_carousel3.setAttribute("src", images[0]);
  let element_description3 = document.getElementById('description');
  element_description3.innerText = randomMember(descriptions);
